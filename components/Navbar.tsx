...
export default function Navbar() {
    ...
    return (
        <nav
            className="border-b sticky top-0 z-50 backdrop-blur-md bg-background/80"
            style={{ 
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        {user && (
                            <>
                                <Link
                                    href="/discover"
                                    className="font-medium hover:opacity-80 transition-all duration-200 relative group text-muted-foreground"
                                >
                                    <span className="group-hover:text-primary transition-colors">Discover</span>
                                ...
                                <Link
                                    ...
                                    className="font-medium hover:opacity-80 transition-all duration-200 relative group text-muted-foreground"
                                >
                                    <span className="group-hover:text-primary transition-colors">Matches</span>
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200"></span>
                                </Link>
                                <Link
                                    href="/chat"
                                    className="font-medium hover:opacity-80 transition-all duration-200 relative group text-muted-foreground"
                                >
                                    <span className="group-hover:text-primary transition-colors">Messages</span>
                                    <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary group-hover:w-full transition-all duration-200"></span>
                                </Link>
                            </>
                        )}
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-full hover:bg-white/10 transition-all duration-200 group relative"
                            title={theme === "luna" ? "Switch to Sol (Light)" : "Switch to Luna (Dark)"}
                            aria-label={theme === "luna" ? "Switch to light mode" : "Switch to dark mode"}
                        >
                            {theme === "luna" ? (
                                <svg
                            ...
                            <span className="sr-only">{theme === "luna" ? "Sol" : "Luna"}</span>
                        </button>
